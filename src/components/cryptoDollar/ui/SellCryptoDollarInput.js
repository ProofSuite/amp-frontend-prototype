...
class SellCryptoDollarInput extends Component {
  ...
  handleSubmit = () => {
    ...
    this.props.sellCryptoDollar({ tokens, sender, value, gas, gasPrice })
  }
...
SellCryptoDollarInput.propTypes = {
  sellCryptoDollar: PropTypes.func,
  status: PropTypes.object
}

export default SellCryptoDollarInput
